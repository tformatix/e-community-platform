package at.fhooe.ecommunity.data.remote.openapi.local.infrastructure
...
open class ApiClient(val baseUrl: String) {
    companion object {
        ...
        const val baseUrlKey = "at.fhooe.ecommunity.data.remote.openapi.local.baseUrl"
    ...
    protected inline fun <reified T: Any?> responseBody(body: ResponseBody?, mediaType: String? = JsonMediaType): T? {
        ...
        if (T::class.java == File::class.java) {
            // return tempfile
            val f = java.nio.file.Files.createTempFile("tmp.at.fhooe.ecommunity.data.remote.openapi.local", null).toFile()
            f.deleteOnExit()
