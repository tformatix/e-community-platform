package at.fhooe.ecommunity.data.remote.openapi.cloud.infrastructure
...
open class ApiClient(val baseUrl: String, val client: OkHttpClient = defaultClient) {
    companion object {
        ...
        const val baseUrlKey = "at.fhooe.ecommunity.data.remote.openapi.cloud.baseUrl"
    ...
    protected inline fun <reified T: Any?> responseBody(body: ResponseBody?, mediaType: String? = JsonMediaType): T? {
        ...
        if (T::class.java == File::class.java) {
            ...
            val tempFile = java.nio.file.Files.createTempFile("tmp.at.fhooe.ecommunity.data.remote.openapi.cloud", null).toFile()
